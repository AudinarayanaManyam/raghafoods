...
const scrollToNextSection = ()=>{
    ...
    let targetSection = sections[0]; // default to first section
    for(let i = 0; i < sections.length; i++){
        ...
        if (element) {
            ...
            // If this section is below current scroll position + some buffer
            if (elementTop > currentScrollY + navbarHeight + 50) {
    ...
    scrollToSection(targetSection.id, targetSection.offset);
};
const scrollToSection = (sectionId, offsetBuffer = 100)=>{
    const element = document.getElementById(sectionId);
    if (element) {
        const navbar = document.querySelector('nav');
        const navbarHeight = navbar ? navbar.getBoundingClientRect().height : 64;
        const elementPosition = element.getBoundingClientRect().top + window.scrollY;
        const offsetPosition = elementPosition - navbarHeight - offsetBuffer;
        window.scrollTo({
...
const scrollDownPage = ()=>{
    ...
    const targetScroll = Math.min(currentScrollY + viewportHeight * 0.8, maxScroll);
    window.scrollTo({
        top: targetScroll,
        behavior: 'smooth'
    });
...
function SearchBar({ value, onChange, placeholder = 'Search products...', onEnter }) {
    const handleKeyDown = (e)=>{
        ...
        // Handle Arrow Down key to scroll down
        if (e.key === 'ArrowDown') {
            e.preventDefault();
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$scroll$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scrollToNextSection"])();
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                ...
                className: "w-full px-6 py-3 pl-12 pr-16 text-base sm:text-lg text-gray-700 bg-white border-2 border-gray-300 rounded-full focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-500/50 shadow-sm"
            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                onClick: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$scroll$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scrollToNextSection"],
                ...
                title: "Scroll to next section (or press Arrow Down)",
                type: "button",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9fd6e8bd._.js.map