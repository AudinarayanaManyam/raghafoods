...
const PromoCodes = ()=>{
    ...
    const handleShare = (promo, platform)=>{
        ...
        switch(platform){
            case 'facebook':
                shareUrl = "https://www.facebook.com/sharer/sharer.php?u=".concat(encodeURIComponent(promoUrl));
                break;
            case 'twitter':
                shareUrl = "https://twitter.com/intent/tweet?text=".concat(encodeURIComponent(promoText), "&url=").concat(encodeURIComponent(promoUrl));
                break;
            case 'whatsapp':
                shareUrl = "https://wa.me/?text=".concat(encodeURIComponent(promoText + ' ' + promoUrl));
                break;
            case 'linkedin':
                shareUrl = "https://www.linkedin.com/sharing/share-offsite/?url=".concat(encodeURIComponent(promoUrl));
                break;
            case 'email':
                shareUrl = "mailto:?subject=".concat(encodeURIComponent("Great Offer from Raaga Foods"), "&body=").concat(encodeURIComponent(promoText + '\n\n' + promoUrl));
                break;
            case 'copy':
            ...
            case 'native':
                if ("object" !== 'undefined' && 'share' in navigator) {
                    navigator.share({
                        title: "Raaga Foods Offer - ".concat(promo.title),
                        text: promoText,
                        url: promoUrl
                    });
                }
                                            ...
                                            isShareMenuOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        "object" !== 'undefined' && 'share' in navigator && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
//# sourceMappingURL=src_5123cced._.js.map