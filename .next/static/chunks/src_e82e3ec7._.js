...
const StarRating = (param)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            hasHalfStar && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                className: "".concat(sizeClasses[size], " text-yellow-400"),
                fill: "currentColor",
                viewBox: "0 0 20 20",
                children: [
...
function ProductsList(param) {
    ...
    const [displayCount, setDisplayCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(8); // Initially show 12 products
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                try {
                    const allKeys = Object.keys(localStorage).filter({
                        "ProductsList.useEffect.allKeys": (k)=>k.startsWith('userReviews_')
                    }["ProductsList.useEffect.allKeys"]);
                    let loaded = [];
                    allKeys.forEach({
                        "ProductsList.useEffect": (key)=>{
    ...
    const handleAddReview = (review)=>{
        setLocalReviews((prev)=>{
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                try {
                    const key = "userReviews_".concat(review.productId);
    ...
    const getReviewsForProduct = (productId)=>{
        return [
            ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$reviews$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["reviews"].filter((r)=>r.productId === productId),
...
_s(ProductsList, "BIO42tDvL/IFblQSXr/QDGVzz54=", false, function() {
    return [
...
//# sourceMappingURL=src_e82e3ec7._.js.map